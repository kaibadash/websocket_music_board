...
class MusicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create music" do
    assert_difference('Music.count') do
      post musics_url, params: { music: { artist: @music.artist, description: @music.description, title: @music.title } }
    end
  ...
  test "should update music" do
    patch music_url(@music), params: { music: { artist: @music.artist, description: @music.description, title: @music.title } }
